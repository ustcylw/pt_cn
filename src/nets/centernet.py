...
class CenterNet_Resnet50(nn.Module):
    ...
    def write_graph(self, input_shape=(1, 3, 512, 512), model_dir='./', show_in_nb=False):
        write_graph(self, torch.rand(input_shape), model_dir, show_in_nb=show_in_nb)
