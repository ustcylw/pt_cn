...
from src.dataset.utils import (cvtColor, get_classes, preprocess_input, resize_image,
                         show_config)
from src.dataset.utils_bbox import decode_bbox, postprocess
...
class CenterNet(object):
    _defaults = {
        ...
        "model_path"        : '/data/ylw/code/pl_cn/checkpoints/centernet_000001/396.pth',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        with torch.no_grad():
            ...
            if self.backbone == 'hourglass':
                ...
                outputs = [outputs[-1]["hm"], outputs[-1]["wh"], outputs[-1]["reg"]]
            #-----------------------------------------------------------#
            #   利用预测结果进行解码
            #-----------------------------------------------------------#
